...
Succesfully downloaded and Imported the dataset to (googlesheets/excel) then prepared to CLEAN and ORGANIZE the data.
...
* So the percentage salary increase grew by 7.7%.
...
* library(janitor).
* 
* I imported my clean data to Rstudio with this package: library(readr)
* #### The code:
...
* Then changed the variable to (salaries <- "Allegheny County Employee Salaries - Allegheny County Employee Salaries 2022 (1).csv") (for a shorter and clearer code).
...
* Alpha refers to the opacity of a geom to show other points.
* And the visuals shows that the female gender has recorded the highest salary.
